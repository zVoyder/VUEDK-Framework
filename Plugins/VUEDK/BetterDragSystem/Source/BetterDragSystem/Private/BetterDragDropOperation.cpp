...
void UBetterDragDropOperation::Init(UUserWidget* InOwnerWidget, UUserWidget* InDragVisual, UObject* InPayload, const ESlateVisibility InOwnerWidgetVisibility)
{
