...
public:
	 ...
	 */
	void Init(UUserWidget* InOwnerWidget, UUserWidget* InDragVisual, UObject* InPayload, const ESlateVisibility InOwnerWidgetVisibility, const bool bRemoveOnDrag);
	...
	ESlateVisibility GetOwnerWidgetVisibility() const;

	UFUNCTION(BlueprintPure)
	bool HasRemoveOwnerWidgetOnDrag() const;

	UFUNCTION(BlueprintPure)
	TArray<FKey> GetDropKeys() const;
