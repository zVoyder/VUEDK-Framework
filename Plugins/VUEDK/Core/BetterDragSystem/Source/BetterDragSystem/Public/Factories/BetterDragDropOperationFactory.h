...
public:
	 ...
	 * @param bRemoveOnDrag Whether to remove the owner widget from the viewport during the drag.
	 * @return The created BetterDragDropOperation instance.
	 */
	UFUNCTION(BlueprintCallable, Category = "BetterDrag")
	static UBetterDragDropOperation* CreateBetterDragDropOperation(const TSubclassOf<UBetterDragDropOperation> DragDropOperationClass, UUserWidget* OwnerWidget, UUserWidget* DragVisual, UObject* Payload, const ESlateVisibility OwnerWidgetVisibility, const bool bRemoveOnDrag);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "BetterDrag")
	static UBetterDragDropOperation* CreateBetterDragDropOperationWithKeys(const TSubclassOf<UBetterDragDropOperation> DragDropOperationClass, UUserWidget* OwnerWidget, UUserWidget* DragVisual, UObject* Payload, const ESlateVisibility OwnerWidgetVisibility, const bool bRemoveOnDrag, const TArray<FKey> DropKeys);
};
