...
void UMenuWidget::Init(UMenuManager* InMenuManager, const FGameplayTag InMenuTag)
{
...
FGameplayTag UMenuWidget::GetMenuTag() const
{
	return MenuTag;
}

UMenuManager* UMenuWidget::GetMenuManager() const
{
	return MenuManager;
}
