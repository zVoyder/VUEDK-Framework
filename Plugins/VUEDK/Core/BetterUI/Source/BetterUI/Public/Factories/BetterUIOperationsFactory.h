...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "BetterUI|Factory", meta = (DefaultToSelf = "OwnerWidget", HidePin = "OwnerWidget"))
	static UBetterSwitchOperation* CreateBetterSwitchOperationWithContainer(UUserWidget* OwnerWidget, UWidgetSwitcher* InSwitcher, UPanelWidget* InPanelContainer);
};
