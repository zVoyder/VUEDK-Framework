...
public:
	 ...
	 * @param InMenuTag The tag identifying this menu (used for event broadcasting).
	 */
	void Init(UMenuManager* InMenuManager, const FGameplayTag InMenuTag);
