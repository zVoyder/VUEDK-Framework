...
public:
	static TWeakObjectPtr<UInputsHandlerSubsystem> InputsHandlerSubsystem;

public:
	/**
	 * Initializes the InputsHandlerUtility with the given InputsHandlerSubsystem.
	 * @param InInputsHandlerSubsystem The InputsHandlerSubsystem to use.
	 */
	static void Init(UInputsHandlerSubsystem* InInputsHandlerSubsystem);
