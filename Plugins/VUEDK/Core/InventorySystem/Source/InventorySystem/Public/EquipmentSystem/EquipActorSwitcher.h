...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable)
	void WithdrawActorAtSlot(const int32 SlotIndex);
	...
	UFUNCTION(BlueprintPure)
	int32 GetCurrentHeldActorIndex() const;
...
protected:
	 ...
	 * @param bFindNewActorToHold If true, finds a new actor to hold after removal (default: true).
	 */
	void RemoveEquipActor(const int32 SlotIndex, bool bFindNewActorToHold = true);
