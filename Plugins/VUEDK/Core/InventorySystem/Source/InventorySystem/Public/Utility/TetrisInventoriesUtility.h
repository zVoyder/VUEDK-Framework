...
private:
	static TWeakObjectPtr<UTetrisInventoryEventsHandlerSubsystem> EventsHandlerSubsystem;
	
public:
	static void SetTetrisEventsHandler(UTetrisInventoryEventsHandlerSubsystem* InEventsHandlerSubsystem);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Gameplay|Tetris Inventory System")
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Gameplay|Tetris Inventory System")
