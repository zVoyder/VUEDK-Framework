...
public:
	 ...
	 * @param Quantity Quantity to assign to the new item (default: 1).
	 * @return Pointer to the created URPGItem instance.
	 */
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", HidePin = "bBuildItem"), Category = "RPGSystem|Factories")
	static URPGItem* CreateRPGGenericItem(UObject* WorldContextObject, URPGItemData* Data, const URPGItemBaseGenerationData* GenerationData, int32& OutOverflow, const bool bBuildItem = true, const int32 Quantity = 1);
	 ...
	 * @return Pointer to the created URPGGearItem instance.
	 */
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject"), Category = "RPGSystem|Factories")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "RPGSystem|Factories")
